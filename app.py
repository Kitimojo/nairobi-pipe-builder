...
# Page Setup
st.set_page_config(page_title="Nairobi Pipe Builder v6.0", layout="wide")
...
# --- UI ---
st.title("Nairobi Pipe Code Builder v6.0")
...
with col_left:
    ...
    # NORMAL LOCATIONS → SHOW NORMAL SHIFTS
    else:
    ...
    # --- ENFORCE SIG RULES ---
    if any(s in SHIFTS_SIG for s in sel_shifts):
        if "Sig" not in sel_locs:
